    ...
    <section className="relative min-h-[60vh] w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 h-full w-full flex items-center justify-center">
        <div className="text-center px-6 max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-tight text-white drop-shadow-[0_0_30px_rgba(16,185,129,0.35)]">
            Geo-temporal Weather Forecast Platform
          </h1>
          <p className="mt-4 text-base sm:text-lg md:text-xl text-emerald-100/90">
